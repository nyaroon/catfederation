...
import 'schema/cats_record.dart';
...
export 'schema/cats_record.dart';
...
/// Functions to query CatsRecords (as a Stream and as a Future).
Stream<List<CatsRecord>> queryCatsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CatsRecord.collection,
...
Future<List<CatsRecord>> queryCatsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CatsRecord>> queryCatsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,

...
import '../create_cat_profile_new/create_cat_profile_new_widget.dart';
import '../edit_cat_profile/edit_cat_profile_widget.dart';
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            ...
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/doggiesocial-mhunoo/assets/6ad5gmiaeui5/cat_profile_2.jpg',
                                          ),
                                          fit: BoxFit.fitWidth,
                                        ),
                                      ),
                        ...
                        onPressed: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: CreateCatProfileNewWidget(),
                            ),
                          );
                        },
                        text: 'Add a Dog',
                              ...
                              Container(
                                ...
                                child: StreamBuilder<List<CatsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<CatsRecord> listViewCatsRecordList =
                                        snapshot.data!;
                                    if (listViewCatsRecordList.isEmpty) {
                                      return Center(
                                        child: Image.asset(
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount: listViewCatsRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewCatsRecord =
                                            listViewCatsRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    imageUrl:
                                                      ...
                                                      listViewCatsRecord
                                                          .catPhoto,
                                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/doggiesocial-mhunoo/assets/0ugd1nv1agx8/rana-sawalha-X7UR0BDz-UY-unsplash.jpg',
                                                    ),
                                                    width: 100,
                                                    height: 100,
                                                    fit: BoxFit.cover,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Image
                                                                      ...
                                                                      valueOrDefault<
                                                                        ...
                                                                        userPostUsersRecord
                                                                            .photoUrl,
                                                                        'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/doggiesocial-mhunoo/assets/bsrkuevlvgqk/cat_profile_3.jpg',
                                                                      ),
                                                                      fit: BoxFit
                                                                          .fitWidth,
                                                                    ),

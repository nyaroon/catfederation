...
class CreateCatProfileNewWidget extends StatefulWidget {
  const CreateCatProfileNewWidget({Key? key}) : super(key: key);

  @override
  _CreateCatProfileNewWidgetState createState() =>
      _CreateCatProfileNewWidgetState();
}

class _CreateCatProfileNewWidgetState extends State<CreateCatProfileNewWidget> {
